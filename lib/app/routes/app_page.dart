...
class AppPage{
  static final pages=[
    ...
    GetPage(name: '/gsfirst', page: () => GetStartedScreen(index: 0,),transition: Transition.noTransition),
    GetPage(name: '/gssecond', page: () => GetStartedScreen(index: 1,),transition: Transition.noTransition),
    GetPage(name: '/gsthird', page: () => GetStartedScreen(index: 2,),transition: Transition.noTransition),
    GetPage(name: '/login', page: () => LoginPage(),transition: Transition.noTransition),
    GetPage(name: '/signup', page: () => SignupPage(),transition: Transition.noTransition),
    GetPage(name: '/dashboard', page: () => Dashboard(),transition: Transition.noTransition),
    GetPage(name: '/detailsscreen', page: () => TaskDetailsScreen(taskindex: Get.arguments as int),transition: Transition.noTransition),
