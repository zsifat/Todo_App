          ...
          child: Obx(
            () {
              if (taskController.isLoading.value) {
                ...
                double dprogess =
                    _Dailyprogress(dailyTasKController.dailytasks);
                    ...
                    children: [
                          ...
                          TextButton.icon(
                            onPressed: () async {
                              ...
                              taskController.updateTasksBasedOnUserData(
                                  userController.userData.value);
                              dailyTasKController
                                  .updateDailyTasksBasedOnUserData(
                                      userController.userData.value);
                            },
                            label: Text(
                              'Sync',
                      ...
                      taskController.tasks.isNotEmpty
                                ...
                                itemBuilder: (context, index) {
                                  return InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Obx(
                                        () {
                                          var progress = taskController
                                              .calculateProgress(taskController
                                                  .tasks[index].todos!);
                                          return Column(
                                            mainAxisAlignment:
                          ...
                          : Padding(
                              ...
                              child: Center(
                                  child: Text(
                                'Click on \'Add task\' to add new task',
                                style: GoogleFonts.poppins(
                                    fontSize: 14,
                                    color: themeContoller.isDarkMode.value
                                        ? Colors.white
                      ...
                      dailyTasKController.dailytasks.isNotEmpty
                          ? Flexible(
                              child: ListView.builder(
                                itemCount:
                                    dailyTasKController.dailytasks.length,
                                itemBuilder: (context, index) {
                                  return Obx(
                                    () {
                                      return Container(
