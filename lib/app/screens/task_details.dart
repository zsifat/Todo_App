          ...
          () => Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(
                  () {
                    var progress = taskController.calculateProgress(
                        taskController.tasks[taskindex].todos!);
                    return Stack(
                      children: [
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  trailing: Checkbox(
                                    ...
                                    value: isCheked,
                                    onChanged: (value) {
                                      taskController.toogleTodoStatus(taskindex,
                                          task.todos!.keys.toList()[index]);
                                    },
                                  ),
                                );
                              },
